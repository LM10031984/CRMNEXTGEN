...
| **DocuSeal LLC** (`api.docuseal.eu`) | Signature électronique des pièces contractuelles | Centres de données **de l'Union européenne** (DPA §11.5) | UE pour l'hébergement. ⚠ Sous-traitant **établi aux États-Unis** : accès distant hors EEE contractuellement prévu pour le support et la sécurité — voir Transferts hors UE et [dpa/docuseal.md](dpa/docuseal.md) |
...
| **Accès distant aux pièces mises à la signature** (support, maintenance, sécurité, réponse à incident, continuité) | DocuSeal LLC | États-Unis | **DPA signé le 2026-09-10** — [dpa/docuseal.pdf](dpa/docuseal.pdf). Les données sont **hébergées dans l'Union** (§11.5) ; le transfert tient à l'accès distant par un sous-traitant établi aux États-Unis, explicitement encadré : CCT (UE) **2021/914 module 2** + UK Addendum + adaptations suisses (Schedule 1), accès limité au nécessaire sous les contrôles de l'annexe II. Réquisitions d'autorité publique notifiées sauf interdiction légale, pas de divulgation volontaire (§11.3). Sous-traitants ultérieurs par renvoi (annexe III) — **liste à capturer à la mise en service**. Voir [dpa/docuseal.md](dpa/docuseal.md). |
...
| 8 | **DocuSeal LLC** | Signature électronique (instance **UE**, `docuseal.eu`) | PDF des pièces contractuelles (identité, adresse, n° SS et IBAN véhiculés par le dossier AGEFICE) + données de signature (email, IP, horodatages, image de la signature) | ✅ **DPA signé 2026-09-10** : [dpa/docuseal.pdf](dpa/docuseal.pdf) · fiche [dpa/docuseal.md](dpa/docuseal.md) |
