...
export function TimelineStep({
  ...
  return (
    ...
    >
      {/* Header — A10' 2026-06-09 (révision feedback Laurent) : wrapper
          en <div role="button"> au lieu de <button> natif. Raison : badge,
          caption, action peuvent tous trois recevoir un ReactNode contenant
          un <button> ; tant que le wrapper était un <button>, on rouvrait
          le risque "nested button" dès qu'un de ces slots évoluait. Le
          pattern div+role+tabIndex+keyDown est l'idiom standard (Radix,
          HeadlessUI) pour les zones cliquables qui doivent contenir
          d'autres contrôles. */}
      <div
        role="button"
        tabIndex={0}
        ...
        className="w-full p-5 sm:p-6 flex items-start gap-4 text-left hover:bg-muted/10 transition-colors cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
      >
        <div
          className={cn(
