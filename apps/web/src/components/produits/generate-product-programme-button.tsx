  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        onClick={() => run(true)}
        disabled={pending}
        title="Régénérer (force une nouvelle génération du programme avec les champs actuels)"
        className="inline-flex items-center justify-center h-9 w-9 rounded-md border border-border bg-white hover:bg-muted/40 text-muted-foreground hover:text-foreground disabled:opacity-70 disabled:cursor-wait"
      >
