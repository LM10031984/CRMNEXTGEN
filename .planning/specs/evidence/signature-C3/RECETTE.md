...
## 2. Déclarer le webhook chez DocuSeal

URL à poser dans DocuSeal (Settings → Webhooks) — **l'alias de BRANCHE**, pas
l'URL d'un déploiement : elle est stable d'un déploiement à l'autre.

```
https://qualiof-git-feat-signature-docs-signes-laurents-projects-3806ab87.vercel.app/api/webhooks/docuseal
```

Événements à cocher : `form.completed`, `form.declined`, `submission.completed`,
`submission.expired`. Secret : **exactement** la valeur de
...
## 4. Le parcours, et ce qu'on observe à chaque étape
...
## 5. Ce qu'il faut verser ici après la recette
...
## 6. Après la recette, sans attendre
