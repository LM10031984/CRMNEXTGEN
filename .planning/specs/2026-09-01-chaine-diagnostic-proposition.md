...
##### D-29 (OUVERTE) — un champ « moyens pédagogiques » au niveau du PRODUIT ?

**Question** : faut-il un champ « moyens pédagogiques » au niveau du **PRODUIT**,
qui viendrait **compléter** celui de l'organisme dans le programme composé ?

**D'où elle vient** : posée le 11/09/2026 en retirant des déroulés de modules des
moyens pédagogiques **spécifiques à un programme** — « études de cas réels issus du
marché immobilier » (`drive:068`, `drive:069`), « exercices guidés pas à pas sur la
rédaction de prompts » (`drive:067`) — alors que la rubrique « Moyens pédagogiques
et techniques » du programme composé se remplit en **GÉNÉRIQUE depuis l'organisme**.
On a donc retiré du spécifique qui n'a **aucun point de chute** aujourd'hui.

Le retrait lui-même n'est pas en cause : un déroulé de module porte des **étapes
d'animation**, pas des mentions d'organisme (lot 1 bis du 11/09, filtre
`packages/db/scripts/lib/mentions-organisme.ts`). La question est de savoir où ce
texte devrait vivre.

**C'est une décision de MODÈLE, elle revient à Laurent et elle attend.** Elle n'est
pas implémentée, et rien dans le code ne l'anticipe.

**Le texte retiré est conservé**, programme par programme et mot pour mot, dans
`.planning/quick/260911-kwf-lot-1-extraction-retirer-les-pieds-de-pa/260911-kwf-SUMMARY-02.md`.
C'est la seule trace : si D-29 est tranchée dans le sens d'un champ produit, c'est
là qu'on le reprendra.
