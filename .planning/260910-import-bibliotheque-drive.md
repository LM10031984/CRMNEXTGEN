...
_Simulation (dry-run) le 2026-09-10 · instantané du 2026-09-10 · tenant « Start Academy »._

## En un coup d’œil

- **74** rayons créés, **0** mis à jour, **2** ignorés
...
- `drive:046` « Tracfin » ressemble au produit existant `PROD-0671` (ACTIF). Le rayon est créé À CÔTÉ : rattacher des modules à un produit vendu changerait sa page publique.
- `drive:053` « Cycle complet de prospection, relation client et négociation immobilière » ressemble au produit existant `PROD-053` (ACTIF). Le rayon est créé À CÔTÉ : rattacher des modules à un produit vendu changerait sa page publique.
- `drive:055` « Maitrise des techniques de vente immobilière » ressemble au produit existant `PROD-055` (ACTIF). Le rayon est créé À CÔTÉ : rattacher des modules à un produit vendu changerait sa page publique.
- `drive:074` « Maîtriser l’Intelligence Artificielle pour développer son activité » ressemble au produit existant `PROD-0662` (ACTIF). Le rayon est créé À CÔTÉ : rattacher des modules à un produit vendu changerait sa page publique.
...
| `faros:SA-ACQ-M003` | créé | `BIB-FACQ-M003` | 1 | bloc-unique | somme des modules | Trouver des vendeurs avant les autres |
| `faros:SA-ADM-M001` | créé | `BIB-FADM-M001` | 1 | bloc-unique | somme des modules | AGEFICE - Sécuriser et transmettre sa demande de financement |
