...
**⚠️ EXCLUSION LOT A — noir sur blanc** : **SES-0055 / SES-0056 / SES-0072 sont HORS périmètre Lot A** tant que leurs produits cibles ont un **programme vide** (Anglais / IA générative / Optimisation SI : programMd=0). Programmes à remplir (import comme PROD-0673, ou T2/T3) AVANT toute génération, sinon pack à trous. **SES-0084 N'EST PLUS exclue** : son produit `PROD-0673` porte désormais un programme réel (importé du programme officiel Laurent).
