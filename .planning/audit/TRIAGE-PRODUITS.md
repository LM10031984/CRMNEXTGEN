...
Enjeu : sans re-point, un futur **sync SmartOF re-collapserait** ces produits dans PROD-0662. Non bloquant pour Plan 08/Lot A (produits base déjà corrects). NB Optimisation SI : « secteur financier » CONSERVÉ (public cabinets gestion patrimoine/banque/assurance, cohérent — contrairement à PROD-0673 immobilier où corrigé).
