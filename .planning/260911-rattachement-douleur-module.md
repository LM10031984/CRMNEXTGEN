...
_Régénérée le 2026-09-11 · tenant « Start Academy ». **Les rattachements ne sont pas encore écrits en base.**_
...
- **Le chiffre du contenu à écrire monte à 21**, et c'est voulu. Les 4 douleurs hors champ en sortent, mais les 4 que tu as barrées y entrent, plus les 2 tombées avec la règle des deux mots : une proposition fausse ne couvrait rien, elle le cachait. 17 était le chiffre rassurant ; 21 est le chiffre vrai.
- **Ton tri du 11/09 fait foi** : ce que tu as retenu est ici, ce que tu as barré ne revient pas.

## En un coup d’œil

- **337 unités animables** au catalogue (299 modules, 38 produits vendus)
...
- **21 douleurs restent sans réponse** — 17 sans aucune proposition, plus 4 dont la proposition était fausse et que tu as barrée. C'est là que du contenu reste à écrire.
- **Écarté d'office** : 105 module(s) sans déroulé, 7 de pige, 7 d'un programme non diffusable (D-19 ter), 70 d'un rayon en doublon — d'un produit vendu (D-19 bis) ou d'un autre rayon que tu as tranché
...
|---|---|---|
| Transformation contacts → rendez-vous | 3 — Prospection & entrées vendeurs | le mot « contacts » menait à une formation aux newsletters |
| Indicateurs suivis | 11 — Management, pilotage & vision | accroché au seul mot « régulièrement » |
| Nombre de visites nécessaires par vente | 8 — Visites, offres & transformation | le mot « nécessaires » menait à une synthèse de journée de tournage |
| Processus de collecte d'avis | 9 — Base de données & e-réputation | le mot « collecte » menait à une collecte d’e-mails, pas d’avis |
...
**17 douleurs** n'ont aucun module ni produit animable qui leur réponde. Aucun rapprochement n'a été inventé pour elles : c'est ici que du contenu reste à écrire.

Les **4 douleurs barrées** du §3 sont à ajouter à cette liste : leur proposition était fausse, elles ne sont donc pas couvertes non plus. Soit **21 douleurs** au total.
...
| Avis en ligne rapportés aux ventes | 9 — Base de données & e-réputation | tous | METIER puis IA |
