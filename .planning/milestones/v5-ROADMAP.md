...
- [x] 16-03-PLAN.md — OCR vision (pdf-extract + preinscription-extractor) → callLlm + test (Wave 2)
- [x] 16-04-PLAN.md — closure : tiers D-01a par générateur + test routage/retry→stub (Wave 2)
- [x] 16-05-PLAN.md — re-tuning 5 prompts Claude + bump PROMPT_VERSION (Wave 3)
- [x] 16-06-PLAN.md — pack témoin réel 0-stub + gate RGPD vision (checkpoint, Wave 4)
