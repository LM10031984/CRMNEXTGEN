...
**Plans**: 10 plans
Plans:
- [ ] 22-01-PLAN.md — Runbook de bascule + plan de rollback (écrits AVANT la fenêtre) — CUT-01 [Wave 1]
- [ ] 22-02-PLAN.md — Portage Google 3 vars env-first TDD + audit/fixes logs PII + label Ollama — CUT-01/RGPD-01 [Wave 1]
...
| 22. Bascule prod + RGPD | v6 | 0/10 | Planned | - |
