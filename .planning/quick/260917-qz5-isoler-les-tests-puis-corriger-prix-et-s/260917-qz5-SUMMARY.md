...
Correction complémentaire du 18/09, après précision de Laurent : l'article 4 affiche l'effectif total non annulé de la session au moment de la génération demandée ; les noms et prix restent limités au dossier. Suppression des préparations documentaires automatiques à la création, à l'inscription et au passage au statut Terminée. Les boutons de génération manuelle restent disponibles. Source et décision : `docs/convention-effectif-2026-09-18.md`. Validation finale : 4 380 tests réussis, 2 ignorés, lint et TypeScript validés. Aucun document réel régénéré.
