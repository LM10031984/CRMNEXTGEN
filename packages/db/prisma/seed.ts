...
async function seedQualiopiDocCatalog() {
  const docs: Array<{
    ...
    { type: DocType.CERTIFICAT_REALISATION, name: 'Certificat de réalisation', phase: 'Formation', qualiopiIndicator: 'Légal Art. L6353-1', isMandatory: true, description: "Certificat obligatoire remis à l'apprenant à la fin de la formation (Art. L6353-1) — preuve d'audit rattachée Indicateur 11", recommendedDelay: 'À la fin de la formation', responsible: 'OF' },
