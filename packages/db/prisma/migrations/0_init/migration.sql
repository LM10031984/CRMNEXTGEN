...
-- CreateEnum
CREATE TYPE "LinkRole" AS ENUM ('DIRIGEANT', 'SALARIE', 'EI_SELF', 'AGENT_COMMERCIAL', 'ALTERNANT', 'STAGIAIRE', 'CONTACT', 'FINANCEUR_CONTACT', 'FORMATEUR');
...
-- CreateEnum
CREATE TYPE "DocType" AS ENUM ('CONVENTION', 'PROGRAMME', 'DEROULE_PEDAGOGIQUE', 'CHECKLIST_FORMATION', 'GRILLE_OBS_SESSION', 'CONVOCATION', 'EMARGEMENT', 'ASSIDUITE', 'ATTESTATION_FIN', 'CERTIFICAT_REALISATION', 'AGEFICE', 'EVALUATION_ACQUIS', 'SATISFACTION', 'SATISFACTION_SESSION', 'SUPPORT_PEDAGOGIQUE', 'PRE_ACCORD_OPCO', 'VALIDATION_OPCO', 'FACTURE', 'CGV', 'REGLEMENT_INTERIEUR', 'CUSTOM', 'VEILLE_AUDIT');
...
-- CreateEnum
CREATE TYPE "PedagogicalKind" AS ENUM ('ANALYSE_BESOIN', 'QCM', 'GRILLE_OBS', 'COMPETENCES', 'DEROULE', 'POSITIONNEMENT', 'SATISFACTION_CHAUD', 'SATISFACTION_FROID', 'EMARGEMENT');

-- CreateEnum
CREATE TYPE "ClosureDocKind" AS ENUM ('ATTESTATION', 'CERTIFICAT', 'QCM', 'GRILLE_OBS', 'ANALYSE_BESOIN', 'POSITIONNEMENT', 'SATISFACTION_CHAUD', 'SATISFACTION_FROID', 'DEROULE_PEDA', 'EMARGEMENT');
...
CREATE TABLE "Tenant" (
    ...
    "creditNotePrefix" TEXT DEFAULT 'AVO',
    "invoiceReminderDays" INTEGER[] DEFAULT ARRAY[30, 45]::INTEGER[],
    "cgvMarkdown" TEXT,
    "reglementInterieurMarkdown" TEXT,
    "iban" TEXT,
    "bic" TEXT,
    "emailFrom" TEXT,
    "logoPath" TEXT,
    "signaturePedagoPath" TEXT,
    "signatureDirigeantPath" TEXT,
    "autoAssignLeads" BOOLEAN NOT NULL DEFAULT true,
    "notifyOnLeadAssignEmail" BOOLEAN NOT NULL DEFAULT true,
    "notifyOnLeadAssignBell" BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE "TrainingProduct" (
    ...
    "ageficeFormationType" TEXT,
    "ageficeNiveau" TEXT,
    "ageficeCertif" TEXT,
    "ageficeAttestation" TEXT,
    "ageficeEvaluations" TEXT[],
    "ageficeObligatoire" BOOLEAN,
    "ageficeReconversion" BOOLEAN,
    "ageficeEnEntreprise" BOOLEAN,
    "ageficeMandat" BOOLEAN,
...
CREATE TABLE "TrainingSession" (
    ...
    "needsTrainerLodging" BOOLEAN NOT NULL DEFAULT false,
    "trainerLodgingPlace" TEXT,
    "trainerLodgingDates" TEXT,
    "hasDisabledLearner" BOOLEAN NOT NULL DEFAULT false,
    "disabilityAdaptations" TEXT,
...
CREATE TABLE "SessionParticipant" (
    ...
    "factureEnvoyee" BOOLEAN NOT NULL DEFAULT false,
    "validationOpco" BOOLEAN NOT NULL DEFAULT false,
    "remboursementOpco" BOOLEAN NOT NULL DEFAULT false,
    "paiementClient" BOOLEAN NOT NULL DEFAULT false,
    ...
    "dossierType" "DossierType" NOT NULL DEFAULT 'FORMATION',
...
CREATE TABLE "AgeficeProfile" (
    ...
    "organizationId" TEXT NOT NULL,
    "pointAccueilId" TEXT,
    "pointAccueilLockedManually" BOOLEAN NOT NULL DEFAULT false,
    "paName" TEXT,
    "paNumber" TEXT,
    "paContact" TEXT,
    "paAddress" JSONB,
    ...
    "lastCfpAmount" DOUBLE PRECISION,
    "lastCfpYear" INTEGER,
    "lastCfpEligibleBudget" INTEGER,
    "cfpAttestationKey" TEXT,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "ClosureJob" (
    ...
    "usedStub" BOOLEAN NOT NULL DEFAULT false,
    "startedAt" TIMESTAMP(3),
    "completedAt" TIMESTAMP(3),
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "SessionCalendarSync" (
    ...
    "sentUpdates" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "SessionCalendarSync_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "Invoice_tenantId_status_lastReminderAt_idx" ON "Invoice"("tenantId", "status", "lastReminderAt");
...
-- CreateIndex
CREATE INDEX "RevenueTarget_tenantId_idx" ON "RevenueTarget"("tenantId");

-- CreateIndex
CREATE UNIQUE INDEX "RevenueTarget_tenantId_year_key" ON "RevenueTarget"("tenantId", "year");

-- CreateIndex
CREATE INDEX "SessionCalendarSync_tenantId_sessionId_idx" ON "SessionCalendarSync"("tenantId", "sessionId");

-- CreateIndex
CREATE UNIQUE INDEX "SessionCalendarSync_sessionId_eventKey_key" ON "SessionCalendarSync"("sessionId", "eventKey");
...
-- AddForeignKey
ALTER TABLE "SessionCalendarSync" ADD CONSTRAINT "SessionCalendarSync_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "TrainingSession"("id") ON DELETE CASCADE ON UPDATE CASCADE;
